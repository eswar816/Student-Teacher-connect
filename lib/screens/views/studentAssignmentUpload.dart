...
class StudentAssignUpload extends StatefulWidget {
  @override
  _UploadAssignment createState() => _UploadAssignment();
}

class _UploadAssignment extends State<StudentAssignUpload> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        items: <Widget>[
          ...
          Icon(Icons.view_agenda,size:30,color:Colors.white,),
        ],
        ...
        children: [
          Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                'View your assignment marks here.',
                style: TextStyle(color: Colors.black.withOpacity(.6)),
              ),
            ),
          ),
